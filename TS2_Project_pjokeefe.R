...
# Calculate prediction errors from forecast
proph.forecast <- tail(predict(Prof, forecast.data)$yhat, 168)

Prophet.error <- validation$mw - proph.forecast
...
# Calculate prediction errors from forecast
proph.forecast.test <- tail(predict(Prof.test, forecast.data.test)$yhat, 168)


Prophet.error.test <- test$mw - proph.forecast.test
...
Pass.Forecast_ts <- ts(Pass.Forecast, start = 2022, frequency = 24)

validation_ts <- ts(validation[,2], start = 2022, frequency = 24)


# Calculate prediction errors from forecast
NN.error <- validation_ts - Pass.Forecast_ts
